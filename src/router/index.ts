...
const routes: Array<RouteRecordRaw & { meta?: AppRouteMeta }> = [
    ...
    // Админка
    {
        ...
        children: [
            ...
            { path: 'static-content', name: 'AdminStaticContent', component: () => import('../views/admin/static_content/StaticContent.vue') },
            { path: '/admin/static-content/create', name: 'AdminStaticContentCreate', component: () => import('../views/admin/static_content/StaticContentCreate.vue') },
            { path: 'static-content/:id/edit', name: 'AdminStaticContentEdit', component: () => import('../views/admin/static_content/StaticContentEdit.vue') },
            { path: '/admin/static-content/:id', name: 'AdminStaticContentShow', component: () => import('../views/admin/static_content/StaticContentShow.vue') },
            ...
            { path: 'course-section', name: 'AdminCourseSection', component: () => import('../views/admin/course_section/CoursesSection.vue') },
            { path: '/admin/course_section/create', name: 'AdminCourseSectionCreate', component: () => import('../views/admin/course_section/CourseSectionCreate.vue') },
            { path: 'course-section/:id/edit', name: 'AdminCourseSectionEdit', component: () => import('../views/admin/course_section/CourseSectionEdit.vue') },
            { path: '/admin/course-section/:id', name: 'AdminCourseSectionShow', component: () => import('../views/admin/course_section/CourseSectionShow.vue') },
            ...
            { path: 'lessons-comments', name: 'AdminLessonComment', component: () => import('../views/admin/lesson_comments/LessonComments.vue') },
            { path: '/admin/lessons-comments/:id', name: 'AdminLessonCommentPage', component: () => import('../views/admin/lesson_comments/LessonView.vue') },
