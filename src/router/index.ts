...
const routes: Array<RouteRecordRaw & { meta?: AppRouteMeta }> = [
    ...
    // Админка
    {
        ...
        children: [
            ...
            { path: 'course_section', name: 'AdminCourseSection', component: () => import('../views/admin/course_section/CoursesSection.vue') },
            ...
            { path: 'course_section/:id/edit', name: 'AdminCourseSectionEdit', component: () => import('../views/admin/course_section/CourseSectionEdit.vue') },
            { path: '/admin/course_section/:id', name: 'AdminCourseSectionShow', component: () => import('../views/admin/course_section/CourseSectionShow.vue') },
